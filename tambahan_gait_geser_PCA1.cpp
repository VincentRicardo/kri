...
void loop(){
  if (Serial.available() > 0){
    ...
    if(sudut[0] == 1){
      ...
      board1.setPWM(4, 0, angleToPulse(90)); //kurang 15 erajat
      board1.setPWM(7, 0, angleToPulse(90)); // nambah 15
      board1.setPWM(5, 0, angleToPulse(165)); // ngurang 5
      board1.setPWM(8, 0, angleToPulse(30)); //nambah 5
      tahan_waktu(600);
      ...
      board1.setPWM(1, 0, angleToPulse(95)); //nambah 15
      board1.setPWM(2, 0, angleToPulse(10)); //nambah 5
      tahan_waktu(100);
      //balik posisi awal
      board1.setPWM(1, 0, angleToPulse(80));
      board1.setPWM(2, 0, angleToPulse(5));
