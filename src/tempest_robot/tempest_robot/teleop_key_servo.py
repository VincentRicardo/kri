...
class MyNode(Node):
    ...
    def send_message(self):
        ...
        if key == 'w':
            ...
            message.data = [0, 40, 105, 180, 45, 70, 0, 52, 110, 180, 10, 70, 0, 85, 110, 180, 85, 75, 0]
            self.talking_one.publish(message)
        elif key == 's':
            self.get_logger().info("Mundur") # yang diubah yang index 1 sama 4 sama 7
            message.data = [0, 80, 105, 180, 85, 70, 0, 12, 110, 180, 50, 70, 0, 45, 110, 180, 45, 75, 0]
            self.talking_one.publish(message)
        # elif key == 'd':
        ...
        #     self.talking_one.publish(message)
            ...
            message.data = [1, 60, 105, 180, 65, 70 ,0, 32, 110, 180, 30, 70, 0, 65, 110, 180, 65, 75, 0]
            self.talking_one.publish(message)
        else:
